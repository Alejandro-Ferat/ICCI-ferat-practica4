...
public class Matriz2x2 {
    ...
    /** Este es un metodo privado que agrega espacios a una cadena, recibe dos parametros la cadena y la        cantidad de espacios para agregarle
     */
...
4     * @return una representación en cadena de la matriz de 2×2.
     */
